...
const About = () => {
  return <section id="about" className="section bg-limeswood-beige">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="h-[400px] md:h-[500px] bg-gray-200 rounded-lg overflow-hidden">
              <img alt="Luxury Property in Dubai" className="w-full h-full object-cover" src="/lovable-uploads/332230f7-69b8-4e37-a7a5-a78b389f513a.jpg" loading="lazy" decoding="async" />
        ...
        <div className="mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md hover-scale">
              <div className="text-limeswood-red text-4xl font-playfair mb-4">01</div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover-scale">
              <div className="text-limeswood-red text-4xl font-playfair mb-4">02</div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover-scale">
              <div className="text-limeswood-red text-4xl font-playfair mb-4">03</div>
