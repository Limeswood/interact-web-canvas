  ...
  return <section id="locations" className="section bg-white">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="section-title">Limeswood locations</h2>
        ...
        <Tabs defaultValue="uae" className="w-full">
          <TabsList className="w-full flex mb-8 bg-transparent justify-center">
            {locations.map(location => <TabsTrigger key={location.id} value={location.id} className="data-[state=active]:border-b-2 data-[state=active]:border-whitevill-red data-[state=active]:shadow-none data-[state=active]:rounded-none data-[state=active]:bg-transparent text-lg px-8 py-3">
                {location.name}
              </TabsTrigger>)}
          </TabsList>
                ...
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {location.cities.map((city, index) => <div key={index} className="bg-whitevill-beige p-4 rounded text-center">
                          {city}
                        </div>)}
                    </div>
                  </div>
